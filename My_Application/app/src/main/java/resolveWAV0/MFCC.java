...
public class MFCC {
	...
	private ArrayList<Integer> si = new  ArrayList<Integer>();
	private ArrayList<Integer> sp = new  ArrayList<Integer>();
	private double old_slmean = 0;
	private double new_slmean = 0;
...
//////////////////////////////////////////////////////////////////////////////////////////
			...
			for(int i=0;i<frames_num;i++){
				...
				try{
					...
					for(int k=0;k<(this.frame_len/2+1);k++){
						...
						new_slmean = new_slmean+fft_final[k];
						if(fft_final[k]<power_spectrum_floor) fft_final[k]=power_spectrum_floor;
					}
					if(old_slmean == 0 && new_slmean != 0){
						si.add(i);
					}else if(old_slmean != 0 && new_slmean == 0){
						sp.add(i);
					}
					old_slmean = new_slmean;
	...
	public ArrayList<Integer> getSp() {
		return sp;
	}
}
