...
public class SpeakerTrainingTest {
	...
	public static void main(String[] args) {
		...
		String trainDirectory = "E:\\data_thchs30\\train"; //directory with files of speakers for training (!!!!! only 1 file per one speaker !!!!)
		String databaseOutputFile = "speaker_database.dat"; //the output database file to be generated
		...
		for(int i=0; i<SEARCH_THREADS; i++ ){
			threads[i] = new Thread(new TrainingTask(queue, char_for_speaker,  numOfSpeakers, databaseOutputFile));
			threads[i].start();
		}
